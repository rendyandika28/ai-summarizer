...
function Demo() {
  ...
  useEffect(() => {
    ...
    if (articlesFromLS) setAllArticles(articlesFromLS)
  }, [])
    ...
    <section className='mt-16 w-full max-w-xl'>
      ...
      <div className="flex flex-col w-full gap-2">
        <form className='relative flex justify-center items-center' onSubmit={handleSubmit}>
          ...
          <button disabled={isFetching} type="submit" className='submit_btn peer-focus:border-gray-700 peer-focus:text-gray-700'>🔎</button>
        </form>
